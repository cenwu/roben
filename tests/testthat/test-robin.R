...
test_that("check_parameters_RBVS-SS_sg", {
  ...
  E = scale(matrix(rnorm(n*env,0,1), n, env), scale=FALSE)
  Y= X%*%c(1, 2, 3)+rnorm(n)
  fit=robin(X, Y, E, iterations=5000)
...
test_that("check_parameters_RBVS-SS_i", {
  ...
  Y= X[,2]*E[,1]*2+rnorm(n)
  fit=robin(X, Y, E, iterations=5000, structure="i")
...
test_that("check_parameters_RBVS_sg", {
  ...
  Y= 15 + rnorm(n)
  fit=robin(X, Y, E, iterations=5000, sparse = FALSE, structure="s")
...
test_that("check_parameters_BVS-SS_sg", {
  ...
  fit=robin(X, Y, E, clin, iterations=8000, robust=FALSE, structure="s")
...
test_that("check_parameters_BVS-SS_g", {
  ...
  Y= 15 + rnorm(n)
  fit=robin(X, Y, E, clin, iterations=8000, robust=FALSE, structure="g")
...
test_that("check_parameters_BVS-SS_i", {
  ...
  fit=robin(X, Y, E, clin, iterations=8000, robust=FALSE, structure="i")
...
test_that("check_parameters_BVS_sg", {
  ...
  clin = scale(matrix(floor(runif(n*nclin,-5,5)), n, nclin), scale=FALSE)
  Y= 15 + rnorm(n)
  fit=robin(X, Y, E, clin, iterations=5000, robust=FALSE, sparse = FALSE)
...
test_that("check_parameters_BVS_g", {
  ...
  clin = scale(matrix(floor(runif(n*nclin,-5,5)), n, nclin), scale=FALSE)
  Y= 5+ X%*%c(1, 2, 3, 4)+rnorm(n)
  fit=robin(X, Y, E=NULL, clin, iterations=3000, robust=FALSE, sparse = FALSE, structure="g", debugging = TRUE)
